...
class ApiController extends FOSRestController
{
    ...
    /**
     * @Rest\Post("/active_user", name="active_user")
     *
     * @SWG\Response(
     *     response=201,
     *     description="Active user was successfully identified"
     * )
     *
     * @SWG\Response(
     *     response=500,
     *     description="User sesion expired or token unidentified"
     * )
     *
     * 
     * @SWG\Parameter(
    ...
    public function getAllBoardAction(Request $request) {
        ...
        try {
            ...
            $boards = $em->getRepository("App:Board")->findAll([
                "user" => $userId,
            ]);
    ...
    /**
     * @Rest\Get("/v1/users", name="users_list_all", defaults={"_format":"json"})
     *
     * @SWG\Response(
     *     response=200,
